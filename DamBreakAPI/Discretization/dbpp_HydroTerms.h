 ...
 *   can be treated with numerical discretization such as finite difference
 * scheme and Riemann algorithm (shock-capturing scheme to model discontinuity
 * accurately).
 */
class HydroTerms {
public:
  //	Fonction spécifique à un canal rectangulaire de largeur B
  //	Pression hydrodynamique établi en fonction d'une superficie d'écoulement
  //A
