...
// Design Note (not now, keep it simple!!!)
...
//
// Design Note:
//    signature shall be in terms of scalar field!!! not STL vector!!!
...
public:
  ...
  //  No more std vector in the signature YES right!!!
